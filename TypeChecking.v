...
(* Specific to https://github.com/coq/coq/issues/10688 *) 
...
Proof.    
  ...
  - intros; simpl.
    ...
    + destruct_merges; subst.
      ...
      4:{ eauto. }
      Focus 3.
        econstructor. (* generates 5 sub-goals *)
        3:{ eauto. }
        3:{ eauto. }
        2:{ monoid. }
        (* { validate. } *)
        (* a single goal left over *)
      Unfocus.
      2:{ monoid. }
      * subst; validate.
      * subst; validate.
...
Definition foo (n : nat) := True.

Goal foo 1 /\ foo 2 /\ foo 3.
