...
Proof.
  intros m n A. 
  unfold Mplus. prep_matrix_equality x y.
  clra.
Qed.

Lemma Mplus_0_r : forall {m n : nat} (A : Matrix m n), A .+ Zero m n = A.
Proof.
  intros m n A. unfold Mplus. prep_matrix_equality x y.
  clra.
Qed.
...
Proof.
  ...
  + unfold Id, Mmult in *. prep_matrix_equality x y. 
Admitted.
