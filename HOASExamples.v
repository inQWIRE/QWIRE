...
(*
Definition Box := Box Var.
Definition Typed_Box {W1 W2} := @Typed_Box Var W1 W2.
Transparent Box.
Transparent Typed_Box.
 *)

Notation Box := (Box Var).
Notation Typed_Box := (Typed_Box Var).
Notation Square_Box := (Square_Box Var).
